...
In which we discuss various things
...
We are using the MULTIP (Multi-Instance Learning Paraphrase) model for the Twitter phrase classier. This model was presented in the research paper titled "Extracting Lexically Divergent Paraphrases from Twitter". We will be implementing this model and extending its functionality (time permitting). The model description below is a summary of the paper that presents the MULTIP model. \medskip
...
\item brief discussion of what this is
\item how did it work? (1-2 pg)
\item not so great - get numbers TODO
\item discussion of why
...
\item similar to wordvec, but extends in in these ways….
\item Why is it well suited to our problem specifically?
\item how did it work? (TODO: run this)
