...
\section{Results}
\begin{enumerate}
\item{baseline} F1 -  0.501; Acc - 0.726
\item{Method 1 (phrase vectors)} F1 0.547;  Acc: 0.751
\item{Method 2 (RAE)} F1: 0.326; Acc: 0.74
\end{enumerate}
...
TODO: I couldn't find a date or conference on this one.  probs OK tho

\bibitem{Wordvec Tutorial}
